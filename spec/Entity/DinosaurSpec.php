...
class DinosaurSpec extends ObjectBehavior
{
    ...
    function it_should_default_to_zero_using_custom_matcher()
    {
    ...
    function it_should_retur_full_description_for_tyrannosaurus()
    {
    ...
    {
        //Mock, and "stub" is a fake value of object
